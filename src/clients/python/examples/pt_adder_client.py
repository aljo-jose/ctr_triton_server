...
def test_infer(model_name, input0_data, input1_data, headers=None):
    inputs = []
    outputs = []
    inputs.append(httpclient.InferInput('INPUT0__0', [1, 16], "INT32"))
    inputs.append(httpclient.InferInput('INPUT1__1', [1, 16], "INT32"))
...
if __name__ == '__main__':
    ...
    input1_data = np.full(shape=(1, 16), fill_value=-5, dtype=np.int32)
